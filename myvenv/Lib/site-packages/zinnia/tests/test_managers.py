...
class ManagersTestCase(TestCase):
    ...
    def setUp(self):
        ...
        self.sites = [
            ...
            Site.objects.create(domain='http://domain.com',
                                name='Domain.com')]
        self.authors = [
            Author.objects.create_user(username='webmain',
    ...
    def test_entry_published_manager_advanced_search(self):
        ...
        self.assertEqual(Entry.published.advanced_search(
            'content author:webmain').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
            'content author:contributor').count(), 1)
        self.assertEqual(Entry.published.advanced_search(
            'content author:webmain tag:zinnia').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
            'content author:webmain tag:custom').count(), 1)
        self.assertEqual(Entry.published.advanced_search(
            'content 1 or 2 author:webmain').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
            'content 1 or 2 author:webmain').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
            '(author:webmain content) my').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
            '(author:webmain) or (author:contributor)').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
            '(author:webmain) (author:contributor)').count(), 0)
        self.assertEqual(Entry.published.advanced_search(
            '(author:webmain content) 1').count(), 1)
        self.assertEqual(Entry.published.advanced_search(
            '(author:webmain content) or 2').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
            '(author:contributor content) or 1').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
            '(author:contributor content) or 2').count(), 1)
        self.assertEqual(Entry.published.advanced_search(
            '(author:webmain or ("hello world")) and 2').count(), 1)

        # Complex queries
        self.assertEqual(Entry.published.advanced_search(
            '(author:admin and "content 1") or author:webmain').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
            'author:admin and ("content 1" or author:webmain)').count(), 0)
        self.assertEqual(Entry.published.advanced_search(
            'author:admin and "content 1" or author:webmain').count(), 0)
        self.assertEqual(Entry.published.advanced_search(
            '-(author:webmain and "content 1")').count(), 1)
        self.assertEqual(Entry.published.advanced_search(
            '-(-author:webmain and "content 1")').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
            'category:"category -1" or author:"web main"').count(), 0)
        self.assertEqual(Entry.published.advanced_search(
            'category:"category-1" or author:"webmain"').count(), 2)
        ...
        self.assertEqual(Entry.published.advanced_search(
            'author:*main').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
            'author:*main category:*ory-2').count(), 1)
        self.assertEqual(Entry.published.advanced_search(
            'author:*main or category:cate*').count(), 2)
        self.assertEqual(Entry.published.advanced_search(
