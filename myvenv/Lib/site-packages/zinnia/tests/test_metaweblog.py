...
class MetaWeblogTestCase(TestCase):
    ...
    def setUp(self):
        ...
        # Create data
        self.webmain = Author.objects.create_superuser(
            username='webmain',
    ...
    def test_authenticate(self):
        ...
        self.assertEqual(authenticate('webmain', 'password'),
                         self.webmain)
        self.assertEqual(authenticate('webmain', 'password',
                                      'zinnia.change_entry'),
                         self.webmain)
    ...
    def test_get_tags(self):
        ...
        self.assertEqual(
            self.server.wp.getTags('apikey', 'webmain', 'password'),
            [{'count': 1,
    ...
    def test_delete_post(self):
        ...
        self.assertTrue(
            self.server.blogger.deletePost(
                'apikey', self.entry_1.pk, 'webmain', 'password', 'publish'))
    ...
    def test_get_post(self):
        ...
        self.assertEqual(post['userid'], 'webmain')
        ...
        self.assertEqual(post['wp_author'], 'webmain')
        self.assertEqual(post['wp_author_id'], self.webmain.pk)
        self.assertEqual(post['wp_author_display_name'], 'webmain')
    ...
    def test_edit_post(self):
        ...
        self.assertEqual(entry.authors.all()[0], self.webmain)
